...
class ManagementResources
{
    ...
    {
        return [
            'users' => [User::class, 'Users', ['name' => 'text', 'email' => 'email', 'password' => 'password', 'role' => User::ROLES, 'active' => ['1' => 'Active', '0' => 'Inactive'], 'bio' => 'textarea', 'organization' => 'text'], ['name' => 'required|string|max:120', 'email' => 'required|email|max:255', 'password' => 'nullable|string|min:10', 'role' => 'required|in:super_admin,admin,instructor,student,corporate', 'active' => 'required|boolean', 'bio' => 'nullable|string|max:2000', 'organization' => 'nullable|string|max:255']],
